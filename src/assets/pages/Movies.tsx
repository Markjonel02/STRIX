        ...
        >
          <SwiperSlide data-aos="" lazy>
            <MovieSlider
              ...
              title="Only in STRIX "
              description="STRIX  is the home of amazing original programming that you can’t find anywhere else. Movies, TV shows, specials, and more, all tailored specifically to you."
            />
          </SwiperSlide>
